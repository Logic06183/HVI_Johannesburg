...
```{r}
# Read spatial data (replace with your actual data file paths)
gwpca_sf <- st_read("C:/Users/CraigParker/OneDrive - Wits PHR/Desktop/HVI_Johannesburg")
...
vars <- c("Crowded.dwellings", "No.piped.water", "No.sewerage", 
          "No.electricity", "Unemployment", "No.education", 
          "Poverty", "Poor.health.status", "hypertensi", 
          "diabetes", "heatch")
